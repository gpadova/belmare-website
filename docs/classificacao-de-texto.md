...
| Texto | Onde mora | Por que não é campo |
|---|---|---|
| O h1 da home — "A área externa inteira, para quem especifica e para quem revende." | `components/abertura.tsx` | O argumento do desenho, não conteúdo dentro dele. **Três versões já caíram:** "Quatro fábricas. Um interlocutor." (jargão de organograma) e "Móveis para área externa" (descreve uma fábrica, e a Belmare é representação), as duas em 30/07/2026; e "Sofá, mesa, espreguiçadeira e ombrelone." em 04/08/2026, porque descrevia uma **loja** — quem caía de busca entendia que comprava um sofá ali e descobria depois que a Belmare não vende direto, e os quatro substantivos saíam quase todos do móvel, sem a estrutura nem o estofado. Os objetos não se perderam: desceram para a linha de apoio, onde o concreto cabe sem prometer varejo. Um campo de texto é o caminho de volta para uma das três numa tarde em que ninguém lembra por que caíram. Trocá-lo é reposicionar a empresa, e reposicionamento é conversa, não edição. |
